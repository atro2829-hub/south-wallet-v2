...
/**
 * Canonical icon options for admin dropdowns.
 * Each entry has a stable `key` (stored in DB), a localized `label`,
 * the `dataUrl` for preview rendering, and a `category` for grouping.
 *
 * This is the SINGLE SOURCE OF TRUTH for icon selection in both apps.
 * Admin panels should import this and render a dropdown picker instead
 * of free-text input, so the icon vocabulary stays consistent.
 */
export interface IconOption {
  ...
  labelEn: string;
  dataUrl: string;
  category: 'main' | 'telecom' | 'services' | 'games' | 'crypto' | 'misc';
}

export const iconOptions: IconOption[] = [
  // Main navigation
  { key: 'home', label: 'الرئيسية', labelEn: 'Home', dataUrl: serviceIcons['home'] || '', category: 'main' },
  { key: 'wallet', label: 'المحفظة', labelEn: 'Wallet', dataUrl: serviceIcons['wallet'] || '', category: 'main' },
  { key: 'instant-pay', label: 'دفع فوري', labelEn: 'Instant Pay', dataUrl: serviceIcons['instant-pay'] || '', category: 'main' },
  { key: 'transfer', label: 'تحويل', labelEn: 'Transfer', dataUrl: serviceIcons['transfer'] || '', category: 'main' },
  { key: 'wallet-transfer', label: 'تحويل بين المحافظ', labelEn: 'Wallet Transfer', dataUrl: serviceIcons['wallet-transfer'] || '', category: 'main' },
  { key: 'recharge', label: 'شحن رصيد', labelEn: 'Recharge', dataUrl: serviceIcons['recharge'] || '', category: 'main' },
  { key: 'deposit', label: 'إيداع', labelEn: 'Deposit', dataUrl: serviceIcons['deposit'] || '', category: 'main' },
  { key: 'exchange', label: 'صرافة', labelEn: 'Exchange', dataUrl: serviceIcons['exchange'] || '', category: 'main' },
  { key: 'currency-exchange', label: 'صرافة عملات', labelEn: 'Currency Exchange', dataUrl: serviceIcons['currency-exchange'] || '', category: 'main' },
  { key: 'savings', label: 'ادخار', labelEn: 'Savings', dataUrl: serviceIcons['savings'] || '', category: 'main' },
  { key: 'orders', label: 'الطلبات', labelEn: 'Orders', dataUrl: serviceIcons['orders'] || '', category: 'main' },
  { key: 'support', label: 'الدعم', labelEn: 'Support', dataUrl: serviceIcons['support'] || '', category: 'main' },
  { key: 'offers', label: 'عروض', labelEn: 'Offers', dataUrl: serviceIcons['offers'] || '', category: 'main' },

  // Telecom
  { key: 'telecom', label: 'اتصالات', labelEn: 'Telecom', dataUrl: serviceIcons['telecom'] || '', category: 'telecom' },
  { key: 'yemen-mobile', label: 'يمن موبايل', labelEn: 'Yemen Mobile', dataUrl: serviceIcons['yemen-mobile'] || '', category: 'telecom' },
  { key: 'yo', label: 'YO', labelEn: 'YO', dataUrl: serviceIcons['yo'] || '', category: 'telecom' },
  { key: 'sabafon', label: 'سبأفون', labelEn: 'Sabafon', dataUrl: serviceIcons['sabafon'] || '', category: 'telecom' },
  { key: 'y', label: 'Y', labelEn: 'Y', dataUrl: serviceIcons['y'] || '', category: 'telecom' },
  { key: 'yemen-net', label: 'يمن نت', labelEn: 'Yemen Net', dataUrl: serviceIcons['yemen-net'] || '', category: 'telecom' },

  // Services
  { key: 'services', label: 'الخدمات', labelEn: 'Services', dataUrl: serviceIcons['services'] || '', category: 'services' },
  { key: 'pay-bills', label: 'دفع الفواتير', labelEn: 'Pay Bills', dataUrl: serviceIcons['pay-bills'] || '', category: 'services' },
  { key: 'pay-bill', label: 'فاتورة', labelEn: 'Pay Bill', dataUrl: serviceIcons['pay-bill'] || '', category: 'services' },
  { key: 'electricity', label: 'كهرباء', labelEn: 'Electricity', dataUrl: serviceIcons['electricity'] || '', category: 'services' },
  { key: 'water', label: 'مياه', labelEn: 'Water', dataUrl: serviceIcons['water'] || '', category: 'services' },
  { key: 'government', label: 'حكومي', labelEn: 'Government', dataUrl: serviceIcons['government'] || '', category: 'services' },
  { key: 'internet', label: 'إنترنت', labelEn: 'Internet', dataUrl: serviceIcons['internet'] || '', category: 'services' },
  { key: 'instant-charge', label: 'شحن فوري', labelEn: 'Instant Charge', dataUrl: serviceIcons['instant-charge'] || '', category: 'services' },
  { key: 'app-store', label: 'متجر تطبيقات', labelEn: 'App Store', dataUrl: serviceIcons['app-store'] || '', category: 'services' },
  { key: 'health', label: 'صحة', labelEn: 'Health', dataUrl: serviceIcons['health'] || '', category: 'services' },

  // Games & Entertainment
  { key: 'games', label: 'ألعاب', labelEn: 'Games', dataUrl: serviceIcons['games'] || '', category: 'games' },
  { key: 'gift-cards', label: 'بطاقات هدايا', labelEn: 'Gift Cards', dataUrl: serviceIcons['gift-cards'] || '', category: 'games' },
  { key: 'pubg', label: 'PUBG', labelEn: 'PUBG', dataUrl: serviceIcons['pubg'] || '', category: 'games' },
  { key: 'freefire', label: 'Free Fire', labelEn: 'Free Fire', dataUrl: serviceIcons['freefire'] || '', category: 'games' },

  // Crypto & Investment
  { key: 'crypto', label: 'عملات رقمية', labelEn: 'Crypto', dataUrl: serviceIcons['crypto'] || '', category: 'crypto' },
  { key: 'crypto-invest', label: 'استثمار رقمي', labelEn: 'Crypto Invest', dataUrl: serviceIcons['crypto-invest'] || '', category: 'crypto' },
  { key: 'usdt', label: 'USDT', labelEn: 'USDT', dataUrl: serviceIcons['usdt'] || '', category: 'crypto' },
  { key: 'investment', label: 'استثمار', labelEn: 'Investment', dataUrl: serviceIcons['investment'] || '', category: 'crypto' },
  { key: 'escrow', label: 'وسيط', labelEn: 'Escrow', dataUrl: serviceIcons['escrow'] || '', category: 'crypto' },

  // Misc
  { key: 'digital-wallet', label: 'محفظة رقمية', labelEn: 'Digital Wallet', dataUrl: serviceIcons['digital-wallet'] || '', category: 'misc' },
  { key: 'wallet-services', label: 'خدمات المحفظة', labelEn: 'Wallet Services', dataUrl: serviceIcons['wallet-services'] || '', category: 'misc' },
  { key: 'providers', label: 'مزودون', labelEn: 'Providers', dataUrl: serviceIcons['providers'] || '', category: 'misc' },
  { key: 'manual', label: 'يدوي', labelEn: 'Manual', dataUrl: serviceIcons['manual'] || '', category: 'misc' },
  { key: 'api', label: 'API', labelEn: 'API', dataUrl: serviceIcons['api'] || '', category: 'misc' },
  { key: 'default', label: 'افتراضي', labelEn: 'Default', dataUrl: serviceIcons['default'] || '', category: 'misc' },
];

/**
 * Lookup an icon option by key. Returns the 'default' option if not found.
 */
export function getIconOption(key: string): IconOption {
  return iconOptions.find(o => o.key === key) || iconOptions.find(o => o.key === 'default')!;
}

/**
 * Group icon options by category for dropdown display.
 */
export const iconOptionsByCategory: Record<string, IconOption[]> = iconOptions.reduce((acc, opt) => {
