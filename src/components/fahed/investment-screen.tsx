    ...
    const loadInvestments = async () => {
      try {
        ...
        const rows = (data || []).map(r => ({
          ...
          dailyReturn: Number(r.profit_rate_snapshot) || 0,
          totalReturn: Number(r.expected_return) || 0,
    ...
    try {
      ...
      const { data: investRow, error: investErr } = await supabase
        ...
        .insert({
          ...
          profit_rate_snapshot: selectedPlan.profitRate,
          expected_return: estimatedReturn,
          status: 'active',
